...
usermail=this.user.email;
  ...
  // }
  constructor(private dataservice: DataService, private qrtr: QretriveService,private upload:UploadService) { }
...
console.log(this.userdata)
  ...
  saveAnswer(){
    ...
    this.upload.saveans(reqdata).subscribe((res)=>{
    console.log(res);
    })
}
...
let reqdata = {
  ...
  script: this.answer
      ...
      this.dataservice.check(reqdata).subscribe((res) => {
        ...
        if(this.Response.includes('error:')||this.Response.includes('No')){
