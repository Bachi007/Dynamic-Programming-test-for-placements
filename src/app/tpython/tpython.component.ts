...
let reqdata = {
  ...
  this.doughnutChartData=[this.showQuestions.length,this.testScore,this.questioncount-this.testScore]
    ...
    this.dataservice.storeScore({"language":"python","score":this.testScore,"user":this.userdata.username}).subscribe((res)=>{
...
"text":'hello'+this.userdata.username+' your score in the recent python test is'+this.testScore
